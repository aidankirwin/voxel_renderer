...
The voxel_renderer is based on voxel based video games like Minecraft. It is created entirely in C++ and OpenGL.
...
The terrain is randomly generated using Perlin noise.
