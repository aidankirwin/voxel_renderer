...
The voxel_renderer is based on voxel video games like Minecraft. It is created entirely in C++ and OpenGL. The terrain is randomly generated using Perlin noise.
...
All information on Perlin noise came from www.scratchapixel.com. All information on OpenGL and the assorted libraries used (GLAD, GLFW, stb_image, GLM) came from www.learnopengl.com. Learn OpenGL and Scratchapixel are amazing sources, and I recommend that anyone who is interested in noise functions and/or graphics programming read them.
